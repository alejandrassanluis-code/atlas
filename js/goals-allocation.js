...
const AtlasGoalsAllocation = {
    ...
    totalAssigned(
        ...
        return this.round(
            this.totalAssignedFromSavings(data) +
            this.totalAssignedFromCash(data)
        );
    ...
    totalDivestments(
        ...
        return this.round(
            this.confirmedDivestments(data)
                .reduce(
                    (total, movement) =>
                        total +
    ...
    totalCashFund(
        ...
        return this.round(
            Math.max(
                0,
                this.initialCash(data) +
                this.totalDivestments(data)
            )
        );
    ...
    secondPreviousMonthSavings(
        data = this.data()
    ) {

        return this.monthSavings(
            data,
            this.secondPreviousMonth()
        );
    ...
    previousMonthDifference(
        ...
        return this.round(
            this.previousMonthSavings(data) -
            this.secondPreviousMonthSavings(data)
        );
    ...
    previousMonthTrend(
        ...
        const difference =
            this.previousMonthDifference(data);
    ...
    metric(
        ...
        if (options.extraTrend) {

            classes.push(
                `extra-${options.extraTrend}`
            );
    ...
    summaryPanel(
        ...
        const previousTrend =
            this.previousMonthTrend(data);

        const closed =
            this.closedSavings(data);

        const provisional =
            this.provisionalSavings(data);
    ...
    updateSelectedTotal(form) {
        ...
        const selected =
            this.selectedTotal(form);

        const available =
            this.number(
                form.dataset.available
            );
    ...
    applyContributionEffect(
        ...
        this.recalculateGoalStatus(goal);
    ...
    goalOptions(
        ...
        return this.allocatableGoals(data)
            .map(
                goal => `
    ...
    saveEdit(form) {
        ...
        const originalGoalId =
            form.dataset.originalGoalId;

        const contributionId =
            form.dataset.contributionId;
    ...
    installStyles() {
        ...
        style.textContent = `
            ...
            .atlas-goals-allocation-metric.extra-positive small {
                color:
                    var(
                        --color-success,
                        #67db9d
            ...
            .atlas-goals-allocation-metric.extra-negative small {
                color:
                    var(
                        --color-danger,
                        #ff6978
            ...
            .atlas-goals-allocation-metric.extra-neutral small {
                color: #98a2bb;
            }
            ...
            .atlas-goals-allocation-open {
                border-color:
                    rgba(82, 207, 139, 0.48);
                background:
                    rgba(82, 207, 139, 0.13);
            }
